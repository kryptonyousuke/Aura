        ...
        if self.window.is_none() {
            ...
            let extradata = unsafe {
                ...
                if (*raw_params).extradata.is_null() { 
                    ...
                    std::slice::from_raw_parts((*raw_params).extradata, (*raw_params).extradata_size as usize).to_vec() 
                }
            };

            log::info!("Vídeo file successfuly loaded. Extradata size: {}", extradata.len());
